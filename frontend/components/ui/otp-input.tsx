...
/* Vendored component, kept byte-identical to upstream. It uses the
   latest-ref pattern (assigning `ref.current` during render) and a
   length-sync setState in an effect, both of which the React lint rules
   flag but which are intentional here. */
