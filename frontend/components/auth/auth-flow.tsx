...
function Logo() {
  return (
    <Image
      ...
      height={48}
      priority
      className="w-12 h-12 rounded-full border border-[#333] object-cover mb-6"
    />
  )
}
    ...
    <main className="min-h-screen bg-[#0a0a0a] flex flex-col items-center justify-center px-4">
        ...
        <div className="w-full max-w-sm flex flex-col items-center">
          ...
          {copy.showTerms && (
            <p className="mt-6 text-xs text-[#333] text-center max-w-xs leading-relaxed">
              ...
              <a href="#" className="text-[#555] hover:text-[#aaa]">
                Terms of Service
              </a>{' '}
              and{' '}
              <a href="#" className="text-[#555] hover:text-[#aaa]">
      ...
      {step === 'otp' && (
        <div className="w-full max-w-sm flex flex-col items-center">
          ...
          <p className="text-[#666] text-sm mt-2 mb-8 text-center">
            {copy.otpSubtitle} <span className="text-[#aaa]">{email}</span>
          </p>
          ...
          >
            ...
            <button
              ...
              className="w-full bg-[#e5e5e5] hover:bg-white text-[#0a0a0a] text-sm font-semibold py-3 rounded-md transition-colors disabled:opacity-50"
            >
          ...
          <div className="mt-5 flex flex-col items-center gap-2">
            <p className="text-sm text-[#666]">
              ...
              <button
                ...
                className="font-medium text-[#888] hover:text-white transition-colors disabled:text-[#444] disabled:hover:text-[#444] disabled:cursor-not-allowed"
              >
